...
def analyze_circuit_image(image_bytes, model=None, filename=None):
    ...
    from core.cv_bus_refined_experiment import detect_cv_buses
    ...
    from core.cv_load_experiment import SCALE as LOAD_SCALE, detect_cv_loads
