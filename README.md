...
[프로젝트 개요](#-프로젝트-개요-executive-summary) • [핵심 기술 성과](#-핵심-엔지니어링-및-ai-기술-성과) • [에이전트 워크플로우](./AGENTIC_WORKFLOW.md) • [기술 검증 보고서](./EVALUATION.md) • [시스템 기술문서](./docs/SYSTEM_ARCHITECTURE_AND_TECHNICAL_DOCS.md) • [시스템 아키텍처](#-시스템-아키텍처-system-architecture) • [빠른 시작 가이드](#-빠른-시작-가이드-quick-start)
...
> - 📐 **시스템 상세 설계**: [`docs/SYSTEM_ARCHITECTURE_AND_TECHNICAL_DOCS.md`](./docs/SYSTEM_ARCHITECTURE_AND_TECHNICAL_DOCS.md) — 모듈별 기술 명세 및 API 규격서
