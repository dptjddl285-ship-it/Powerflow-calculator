...
### 핵심 테스트 파일
1. [test_electrical_topology.py](file:///c:/Users/hpo20/OneDrive/바탕%20화면/Project%20List/전력계통대회2/backend_api/tests/test_electrical_topology.py): 1픽셀 갭 브릿지, Zhang-Suen 스켈레톤 보존, 4방향 교차점 vs T분기 구분, 방향성 최단경로 검증.
2. [test_pipeline_policy.py](file:///c:/Users/hpo20/OneDrive/바탕%20화면/Project%20List/전력계통대회2/backend_api/tests/test_pipeline_policy.py): 저해상도 스케일링, Bus 꺾임 거부/단편화 구출, 부하 Bus 결선 필수 규칙, Graph Issue 진단.
3. [test_symbol_conflict_filters.py](file:///c:/Users/hpo20/OneDrive/바탕%20화면/Project%20List/전력계통대회2/backend_api/tests/test_symbol_conflict_filters.py): 화살표 바닥 Bus 오인식 방지, 관통 선로 복원, 변압기 독립 검출, 기하 충돌 필터.
...
* [main.dart](file:///c:/Users/hpo20/OneDrive/바탕%20화면/Project%20List/전력계통대회2/frontend_app/lib/main.dart)의 `_applyAiDataToCanvas()` 및 `DrawingElement` 파싱 로직과 호환되는지 점검.
