...
class ReviewApiService {
  ...
  Future<ReviewDocument> detectObjects(Uint8List imageBytes, String filename) async {
    ...
    if (response.statusCode != 200) {
      throw Exception('객체 검출 요청 실패: HTTP ${response.statusCode} - ${response.body}');
    }
  ...
  Future<Map<String, dynamic>> agentReviewNode(String documentId, ReviewNodeItem node) async {
  ...
  Future<Map<String, dynamic>> detectConnections(String documentId, List<ReviewNodeItem> confirmedNodes) async {
