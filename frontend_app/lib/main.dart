  ...
  Future<void> _fetchDiagnosis() async {
    ...
    try {
      ...
      final res = await http.post(
        ...
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'elements': widget.elements.map((e) => e.toJson()).toList(),
  ...
  Widget _buildStatCard(String title, int diagramVal, int excelVal) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: match ? Colors.green.withOpacity(0.5) : Colors.redAccent.withOpacity(0.6),
          width: 1.5,
        ),
      ),
      child: Column(
                ...
                child: Container(
                  ...
                  child: discrepancies.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          separatorBuilder: (_, __) => const Divider(color: Colors.white10, height: 6),
                          itemBuilder: (ctx, idx) {
                            ...
                            return Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isMissing ? Colors.red.withOpacity(0.2) : Colors.orange.withOpacity(0.2),
                                    borderRadius: BorderRadius.circular(4),
                                    border: Border.all(
                                      color: isMissing ? Colors.redAccent.withOpacity(0.4) : Colors.orangeAccent.withOpacity(0.4),
                                    ),
                                  ),
                                  child: Text(
                                    isMissing ? "누락" : "초과",
